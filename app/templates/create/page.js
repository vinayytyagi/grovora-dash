              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Use placeholders like {"{{name}}"}, {"{{order_id}}"} etc.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`${
                        callToAction && "bg-green-800"
                      } flex items-center gap-2 px-4 py-2 bg-green-500 text-white text-sm font-medium rounded-lg hover:bg-green-600 transition-colors cursor-pointer`}
                    >
                      {!callToAction ? (
              ...
              {quickReplay && (
                <div className="mt-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("quickReplyTitle", e.target.value)
                    }
                    className="w-full text-gray-700 px-3 py-2 border border-green-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("quickReplyNumber", e.target.value)
                    }
                    className="w-full text-gray-700 px-3 py-2 border border-green-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                </div>
                        ...
                        <div className="mt-4  rounded-lg p-4">
                          <div className="max-w-md mx-auto">
                            ...
                            {formData.quickReplyTitle && (
                              <a
                                href={
                                  formData.quickReplyNumber
                                    ? `tel:${formData.quickReplyNumber}`
                                    : "#"
                                }
                              >
                                <button
